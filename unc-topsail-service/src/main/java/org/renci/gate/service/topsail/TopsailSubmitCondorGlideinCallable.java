...
public class TopsailSubmitCondorGlideinCallable implements Callable<SLURMSSHJob> {

    private final Logger logger = LoggerFactory.getLogger(TopsailSubmitCondorGlideinCallable.class);
    ...
    public TopsailSubmitCondorGlideinCallable() {
        super();
    }
